/**
 * Trumbowyg v2.1.6hack - A lightweight WYSIWYG editor
 * Trumbowyg core file
 *
 * this version is a quick hack that removes the creation of a textarea,
 * because on large contents a textarea is just unbearably slow.
 * This current version is in parts broken, but just works for this project
 * (for now).
 * ------------------------
